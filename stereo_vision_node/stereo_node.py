...
class StereoVisionNode(Node):
    def __init__(self):
        ...
        if NPU_AVAILABLE:
            ...
            # Load the exported RKNN model directly from the container's local file
        ...
        self.camera_fov = 1.047 # Approx 60 degrees in radians
    ...
    def timer_callback(self):
        ...
        # Compress frame to JPEG to prevent lagging video feed over network
